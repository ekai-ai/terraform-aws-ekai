...
# mirrors (name collision notes, why each variable exists, etc.) — not
# repeated here to avoid the two copies drifting out of sync in wording while
# still needing to stay in sync in substance.
# ──────────────────────────────────────────────────────────────────────────────
